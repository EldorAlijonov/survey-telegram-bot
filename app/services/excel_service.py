...
class ExcelService:
    HEADERS = [
        ...
        "Maktabdagi sharoit",
        "Darsdan tashqari o'rganish niyati",
        "Qulay vaqt",
        "Qiziqqan yo'nalish",
        "Obuna holati",
        ...
        for index, user in enumerate(users, start=1):
            ...
            sheet.append(
                [
                    ...
                    user.phone or "-",
                    user.address or "-",
                    user.education_place or "-",
                    answer_label(survey.interest_level if survey else None),
                    answer_label(survey.school_condition if survey else None),
                    answer_label(survey.extra_learning_intent if survey else None),
